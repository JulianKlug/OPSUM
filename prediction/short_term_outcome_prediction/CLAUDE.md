...
## Project Overview
Optimize the XGB model at prediction of early neurological deterioration in the next 6 hours

models to evaluate: 
- XGB

### Data
- training/validation data path: /mnt/data1/klug/datasets/opsum/short_term_outcomes/with_imaging/gsu_Extraction_20220815_prepro_30012026_154047/train_data_splits_early_neurological_deterioration_ts0.8_rs42_ns5.pth
    - data structure: splits with training and validation data (input data and labels)
- XGB hyperoptimisation data: /mnt/data1/klug/output/opsum/short_term_outcomes/end_with_imaging/xgb_hyperopt
