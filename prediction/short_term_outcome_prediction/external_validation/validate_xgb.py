...
from prediction.short_term_outcome_prediction.testing.test_xgb import test_final_model


if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='External validation of XGB model on MIMIC data')
    parser.add_argument('-d', '--test_data_path', type=str, required=True,
                        help='Path to MIMIC test data .pth file')
    parser.add_argument('-m', '--model_dir', type=str, required=True,
                        help='Directory containing xgb_final_model.model, scaler.pkl, final_model_config.json')
