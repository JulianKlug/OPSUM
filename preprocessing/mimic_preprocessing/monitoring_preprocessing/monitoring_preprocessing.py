...
import os
import numpy as np
from preprocessing.mimic_preprocessing.monitoring_preprocessing.GCS_extraction import get_GCS
from preprocessing.mimic_preprocessing.monitoring_preprocessing.nihss_extraction import get_nihss
from preprocessing.geneva_stroke_unit_preprocessing.utils import restrict_variable_to_possible_ranges
